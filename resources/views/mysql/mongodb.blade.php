...
<div class="space-y-4">
    <div class="flex items-center gap-3 mb-2 flex-wrap">
        ...
        <a href="{{ route('mysql.mongodb') }}" class="px-3 py-1.5 text-sm font-medium bg-indigo-100 text-indigo-700 rounded-lg">MongoDB</a>
    </div>
    <div class="bg-white rounded-xl shadow-sm border p-5">
        <h3 class="text-sm font-semibold text-gray-700 mb-3"><i class="fas fa-leaf mr-2 text-green-500"></i>MongoDB</h3>
        @if($installed)
        ...
        @else
            <div class="text-center py-8"><i class="fas fa-info-circle text-3xl text-gray-300 mb-2"></i><p class="text-gray-500">MongoDB is not installed on this server.</p></div>
        @endif
    </div>
</div>
@endsection
